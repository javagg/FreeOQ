...
namespace OpenQuant.Trading
{
    public class SolutionRunner : IInstrumentSource
    {
        ...
        private void Connect()
        {
            ...
            OrderManager.OrderCancelReject += new OrderCancelRejectEventHandler(this.SQ_OrderManager_OrderCancelReject);
        ...
        private void OrderManager_NewOrder(OrderEventArgs args)
        {
            ...
            if (!this.strategies.TryGetValue(args.Order.Strategy, out strategyRunner) || !strategyRunner.Enabled)
                return;
            strategyRunner.SetNewOrder(args.Order);
        }
        ...
        private void OrderManager_OrderStatusChanged(OrderEventArgs args)
        {
            ...
            if (!this.strategies.TryGetValue(args.Order.Strategy, out strategyRunner) || !strategyRunner.Enabled)
                return;
            strategyRunner.SetOrderStatusChanged(args.Order);
        }
