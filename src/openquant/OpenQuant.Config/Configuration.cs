...
namespace OpenQuant.Config
{
  public static class Configuration
  {
    ...
    public static ConfigurationMode ActiveMode
    {
      ...
      set
      {
        ...
        if (Configuration.ConfigurationModeChanging != null)
          Configuration.ConfigurationModeChanging((object) typeof (Configuration), args);
        if (args.Cancel)
          return;
        ...
        if (Configuration.ConfigurationModeChanged == null)
          return;
        Configuration.ConfigurationModeChanged((object) typeof (Configuration), EventArgs.Empty);
      }
    }
    ...
    public static void Init(ConfigurationMode activeMode, ConfigurationInfoList infoList)
    {
      ...
      ProviderManager.Added += new ProviderEventHandler(Configuration.ProviderManager_Added);
    }
