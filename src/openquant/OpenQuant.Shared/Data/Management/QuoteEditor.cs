...
namespace OpenQuant.Shared.Data.Management
{
  internal class QuoteEditor : DataObjectEditor
  {
    ...
    {
      return (IDataObject) new Quote(this.dtpDateTime.Value, (double) this.nudBid.Value, (int) this.nudBidSize.Value, (double) this.nudAsk.Value, (int) this.nudAskSize.Value);
    }
