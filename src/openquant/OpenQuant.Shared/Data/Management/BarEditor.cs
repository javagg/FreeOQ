...
namespace OpenQuant.Shared.Data.Management
{
  internal class BarEditor : DataObjectEditor
  {
    ...
    {
      return (IDataObject) new Bar(this.barType, this.barSize, this.dtpDateTime.Value, this.dtpEnd.Value, (double) this.nudOpen.Value, (double) this.nudHigh.Value, (double) this.nudLow.Value, (double) this.nudClose.Value, (long) this.nudVolume.Value, (long) this.nudOpenInt.Value);
    }
