// Type: OpenQuant.Shared.Data.Management.GotoForm
...
namespace OpenQuant.Shared.Data.Management
{
  internal class GotoForm : Form
  {
    ...
    public GotoForm()
    {
      ...
      this.dtpDateTime.CustomFormat = DateTimeFormatInfo.CurrentInfo.ShortDatePattern + " " + DateTimeFormatInfo.CurrentInfo.LongTimePattern;
    }
