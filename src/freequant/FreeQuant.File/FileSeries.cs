...
{
	public class FileSeries : IDataSeries
	{
		...
		public string Description
		{
			...
			set
			{
				if (value.Length > sbyte.MaxValue)
					throw new ArgumentException("format", "too long");
...
//				this.streamer.VmKuLwiT3(this);
		...
		public int MaxBlockSize
		{
			...
			{
				if (value < 2)
					throw new ArgumentOutOfRangeException("", (object)value, "");
...
//				this.streamer.VmKuLwiT3(this); 
		...
		public int ZipLevel
		{
			...
			{
				if (value < 0 || value > 9)
					throw new ArgumentOutOfRangeException("sss", (object)value, "fdds");
				this.zipLevel = value;
//				this.streamer.VmKuLwiT3(this);
			}
		}
		...
		public IndexStatus IndexStatus
		{
			get
			{
				...
				return this.lyMkX4DEV == -1 ? IndexStatus.Old : IndexStatus.Valid;
			}
		}
...
//		[Browsable(false)]
//		object ISeriesObject.this[DateTime datetime]
//		{
//			get
//			{
//				return this[datetime, SearchOption.Exact];
...
//      return (IEnumerator) new LPr0ffVt3PxRVXsGbc(this);
		...
		internal void TaaFdlDDd(string obj0)
		{
			this.name = obj0;
		}
