...
namespace FreeQuant.Providers
{
    ...
    {
        private const string PROVIDER_PROPS_FILE = "provider.properties.xml";
...
//      cusHnTdpjW7M4WgDtf.Save(Framework.Installation.IniDir.FullName + GojrKtfk5NMi1fou68.a17L2Y7Wnd(614));
        ...
        {
            FileInfo fileInfo = new FileInfo(Path.Combine(Framework.Installation.IniDir.FullName, PROVIDER_PROPS_FILE));
            if (!fileInfo.Exists)
                return;
//      CUsHnTDPJW7M4WgDtf cusHnTdpjW7M4WgDtf = new CUsHnTDPJW7M4WgDtf();
