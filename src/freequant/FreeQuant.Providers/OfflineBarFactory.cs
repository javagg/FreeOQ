		...
		private void WJWi7M4Wg([In] IFIXInstrument obj0, [In] DateTime obj1, [In] double obj2, [In] int obj3)
		{
			foreach (BarFactoryItem barFactoryItem in this.Items)
			{
				if (barFactoryItem.Enabled)
				{
					...
					{
						case BarType.Time:
							if (gcuMn6TqoRuEfhwr.bar == null || gcuMn6TqoRuEfhwr.bar.EndTime <= obj1)
							{
								if (gcuMn6TqoRuEfhwr.bar != null)
									this.M28GqE2S2(obj0, gcuMn6TqoRuEfhwr.bar);
								DateTime dateTime1;
								DateTime dateTime2;
								this.iYlXRwvKS(obj1, barFactoryItem.BarSize, out dateTime1, out dateTime2);
								gcuMn6TqoRuEfhwr.bar = this.ssgZj9bjo(BarType.Time, barFactoryItem.BarSize, dateTime1, dateTime2, obj2);
							}
							this.jtf8pUBX1(gcuMn6TqoRuEfhwr.bar, obj2, obj3);
							continue;
						case BarType.Tick:
							if (gcuMn6TqoRuEfhwr.bar == null)
								gcuMn6TqoRuEfhwr.bar = this.ssgZj9bjo(BarType.Tick, barFactoryItem.BarSize, obj1, obj1, obj2);
							this.jtf8pUBX1(gcuMn6TqoRuEfhwr.bar, obj2, obj3);
							gcuMn6TqoRuEfhwr.bar.EndTime = obj1;
							if ((long)++gcuMn6TqoRuEfhwr.WWlIn4O0w == barFactoryItem.BarSize)
							{
								this.M28GqE2S2(obj0, gcuMn6TqoRuEfhwr.bar);
								gcuMn6TqoRuEfhwr.bar = (Bar)null;
						...
						case BarType.Volume:
							if (gcuMn6TqoRuEfhwr.bar == null)
								gcuMn6TqoRuEfhwr.bar = this.ssgZj9bjo(BarType.Volume, barFactoryItem.BarSize, obj1, obj1, obj2);
							this.jtf8pUBX1(gcuMn6TqoRuEfhwr.bar, obj2, obj3);
							gcuMn6TqoRuEfhwr.bar.EndTime = obj1;
