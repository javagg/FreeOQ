// Type: SmartQuant.Indicators.AroonL
...
namespace SmartQuant.Indicators
{
  ...
  public class AroonL : Indicator
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public AroonL(TimeSeries input, int length)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public AroonL(TimeSeries input, int length, Color color)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public AroonL(TimeSeries input, int length, Color color, EDrawStyle drawStyle)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    {
      this.fName = GXPBSPblRhtUOANrS4.LSuAVoYjy(5960) + (object) this.fLength + GXPBSPblRhtUOANrS4.LSuAVoYjy(5980);
      this.fTitle = GXPBSPblRhtUOANrS4.LSuAVoYjy(5986);
      this.Clear();
      this.fCalculate = true;
      if (this.fInput == null || TimeSeries.fNameOption != ENameOption.Long)
        return;
      this.fName = this.fInput.Name + GXPBSPblRhtUOANrS4.LSuAVoYjy(6012) + this.fName;
    }
