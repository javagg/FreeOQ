// Type: SmartQuant.Indicators.CCI
...
namespace SmartQuant.Indicators
{
  ...
  public class CCI : Indicator
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public CCI(TimeSeries input, int length)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public CCI(TimeSeries input, int length, Color color)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public CCI(TimeSeries input, int length, Color color, EDrawStyle drawStyle)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    {
      this.fName = GXPBSPblRhtUOANrS4.LSuAVoYjy(2038) + (object) this.fLength + GXPBSPblRhtUOANrS4.LSuAVoYjy(2052);
      this.fTitle = GXPBSPblRhtUOANrS4.LSuAVoYjy(2058);
      this.Clear();
      this.fCalculate = true;
      if (this.fInput == null || TimeSeries.fNameOption != ENameOption.Long)
        return;
      this.fName = this.fInput.Name + GXPBSPblRhtUOANrS4.LSuAVoYjy(2108) + this.fName;
    }
