// Type: SmartQuant.Indicators.VROC
...
namespace SmartQuant.Indicators
{
  ...
  public class VROC : Indicator
  {
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public VROC(TimeSeries input, int length)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public VROC(TimeSeries input, int length, Color color)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public VROC(TimeSeries input, int length, Color color, EDrawStyle drawStyle)
    {
      RMXbNVLKIIh1UeJavt.ngyLmRPzO9SGQ();
      this.fLength = 14;
      // ISSUE: explicit constructor call
    ...
    {
      this.fName = GXPBSPblRhtUOANrS4.LSuAVoYjy(4914) + (object) this.fLength + GXPBSPblRhtUOANrS4.LSuAVoYjy(4930);
      this.fTitle = GXPBSPblRhtUOANrS4.LSuAVoYjy(4936);
      this.fType = EIndicatorType.Volume;
      this.Clear();
      this.fCalculate = true;
      if (this.fInput == null || TimeSeries.fNameOption != ENameOption.Long)
        return;
      this.fName = this.fInput.Name + GXPBSPblRhtUOANrS4.LSuAVoYjy(4982) + this.fName;
    }
