// Type: SmartQuant.FinChart.AxisBottom
...
namespace SmartQuant.FinChart
{
  public class AxisBottom : Axis
  {
    ...
    public void PaintWithDates(DateTime minDate, DateTime maxDate)
    {
      ...
      EGridSize GridSize = AxisBottom.CalculateSize((double) (ticks2 - ticks1));
      long num1 = 0L;
            ...
            if (ticks3 < num7)
            {
              ...
              if (this.labelEnabled)
              {
                ...
                if (ticks3 % 864000000000L == this.chart.SessionStart.Ticks || ticks3 % 864000000000L == this.chart.SessionEnd.Ticks)
                  format = num5 != 0L ? (new DateTime(num5).Year == new DateTime(ticks3).Year ? FJDHryrxb1WIq5jBAt.mT707pbkgT(4060) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4034)) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4010);
                else if (num5 == 0L)
                {
                  format = FJDHryrxb1WIq5jBAt.mT707pbkgT(4076);
                }
                else
                {
                  DateTime dateTime3 = new DateTime(num5);
                  DateTime dateTime4 = new DateTime(ticks3);
                  format = dateTime3.Year == dateTime4.Year ? (dateTime3.Month == dateTime4.Month ? (dateTime3.Day == dateTime4.Day ? (dateTime3.Minute != dateTime4.Minute || dateTime3.Hour != dateTime4.Hour ? FJDHryrxb1WIq5jBAt.mT707pbkgT(4224) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4204)) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4176)) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4148)) : FJDHryrxb1WIq5jBAt.mT707pbkgT(4112);
                }
      ...
      if (!this.titleEnabled)
        return;
      int num14 = (int) this.chart.Graphics.MeasureString(FJDHryrxb1WIq5jBAt.mT707pbkgT(4238), this.labelFont).Height;
      int num15 = (int) this.chart.Graphics.MeasureString(ticks2.ToString(FJDHryrxb1WIq5jBAt.mT707pbkgT(4256)), this.labelFont).Width;
