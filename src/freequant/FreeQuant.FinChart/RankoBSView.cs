...
namespace FreeQuant.FinChart
{
	public class RankoBSView : SeriesView
	{
		...
		public override Color Color
		{
			get
			{
				return Color.FromArgb(0, byte.MaxValue, 0);
			}
			set
			{
			}
		...
		public override Distance Distance(int x, double y)
		{
			...
			sb.AppendFormat(this.ToolTipFormat, this.barSeries.Name, this.barSeries.Title, bar.DateTime.ToString(this.barSeries.ToolTipDateTimeFormat), (object)bar.High, (object)bar.Low, (object)bar.Open, (object)bar.Close, (object)bar.Volume);
