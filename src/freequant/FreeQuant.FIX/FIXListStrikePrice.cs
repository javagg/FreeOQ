// Type: SmartQuant.FIX.FIXListStrikePrice
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList wLr7YpDwsi;
    private ArrayList IyW7yTGBiV;
    private ArrayList Nyo7hLKp3h;
    private ArrayList RuY7Nem2Z6;
    ...
    {
      return (FIXHopRefIDGroup) this.wLr7YpDwsi[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.wLr7YpDwsi.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.IyW7yTGBiV[i];
      else
    ...
    {
      this.IyW7yTGBiV.Add((object) group);
      ++this.NoHops;
    }
    ...
    {
      if (i < this.NoStrikes)
        return (FIXStrikesGroup) this.Nyo7hLKp3h[i];
      else
        return (FIXStrikesGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXStrikesGroup group)
    {
      this.Nyo7hLKp3h.Add((object) group);
      ++this.NoStrikes;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.RuY7Nem2Z6[i];
      else
    ...
    {
      this.RuY7Nem2Z6.Add((object) group);
      ++this.NoUnderlyings;
    }
  }
}
