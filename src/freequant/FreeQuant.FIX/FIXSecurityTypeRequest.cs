// Type: SmartQuant.FIX.FIXSecurityTypeRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList FSYuKSMkw2;
    private ArrayList zXHu0tXJtF;
    ...
    {
      return (FIXHopRefIDGroup) this.FSYuKSMkw2[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.FSYuKSMkw2.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.zXHu0tXJtF[i];
      else
    ...
    {
      this.zXHu0tXJtF.Add((object) group);
      ++this.NoHops;
    }
  }
}
