// Type: SmartQuant.FIX.FIXCollateralInquiry
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList Yd5ADRMyit;
    private ArrayList GP2APV7vl9;
    private ArrayList zqoAI9eIlm;
    private ArrayList m5EAHaXiKW;
    private ArrayList FWUAWaT64g;
    private ArrayList wQ7ATeR8Um;
    private ArrayList ubvAV8IGyk;
    private ArrayList WdlAm8Ftux;
    private ArrayList lfrAkADt2S;
    private ArrayList H21Anvir1w;
    private ArrayList L2sA16JESZ;
    private ArrayList rEBAi3fg19;
    private ArrayList VuCAlbeyu4;
    ...
    public FIXCollateralInquiry()
    {
      ...
      this.m5EAHaXiKW = new ArrayList();
      this.FWUAWaT64g = new ArrayList();
      this.wQ7ATeR8Um = new ArrayList();
      this.ubvAV8IGyk = new ArrayList();
      this.WdlAm8Ftux = new ArrayList();
      this.lfrAkADt2S = new ArrayList();
      this.H21Anvir1w = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.Yd5ADRMyit[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.Yd5ADRMyit.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.GP2APV7vl9[i];
      else
    ...
    {
      this.GP2APV7vl9.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXCollInquiryQualifierGroup GetCollInquiryQualifierGroup(int i)
    {
      if (i < this.NoCollInquiryQualifier)
        return (FIXCollInquiryQualifierGroup) this.zqoAI9eIlm[i];
      else
    ...
    {
      this.zqoAI9eIlm.Add((object) group);
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.m5EAHaXiKW[i];
      else
    ...
    {
      this.m5EAHaXiKW.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    {
      if (i < this.NoExecs)
        return (FIXExecsGroup) this.FWUAWaT64g[i];
      else
    ...
    {
      this.FWUAWaT64g.Add((object) group);
      ++this.NoExecs;
    }
    ...
    {
      if (i < this.NoTrades)
        return (FIXTradesGroup) this.wQ7ATeR8Um[i];
      else
    ...
    {
      this.wQ7ATeR8Um.Add((object) group);
      ++this.NoTrades;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.ubvAV8IGyk[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.WdlAm8Ftux[i];
      else
    ...
    {
      this.WdlAm8Ftux.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.lfrAkADt2S[i];
      else
    ...
    {
      this.lfrAkADt2S.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.H21Anvir1w[i];
      else
    ...
    {
      this.H21Anvir1w.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXTrdRegTimestampsGroup GetTrdRegTimestampsGroup(int i)
    {
      if (i < this.NoTrdRegTimestamps)
        return (FIXTrdRegTimestampsGroup) this.L2sA16JESZ[i];
      else
    ...
    {
      this.L2sA16JESZ.Add((object) group);
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.rEBAi3fg19[i];
      else
    ...
    {
      this.rEBAi3fg19.Add((object) group);
      ++this.NoStipulations;
    }
    ...
    public FIXDlvyInstGroup GetDlvyInstGroup(int i)
    {
      if (i < this.NoDlvyInst)
        return (FIXDlvyInstGroup) this.VuCAlbeyu4[i];
      else
    ...
    {
      this.VuCAlbeyu4.Add((object) group);
      ++this.NoDlvyInst;
    }
  }
}
