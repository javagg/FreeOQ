// Type: SmartQuant.FIX.FIXOrderMassStatusRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList pGiQVFZS9h;
    private ArrayList ijhQmXXAUZ;
    private ArrayList NMEQkj9tB9;
    private ArrayList aqHQnke3dV;
    private ArrayList FHgQ1P1fNs;
    private ArrayList eGoQiUlqWG;
    private ArrayList fDgQlyXnff;
    ...
    {
      return (FIXHopRefIDGroup) this.pGiQVFZS9h[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.pGiQVFZS9h.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.ijhQmXXAUZ[i];
      else
    ...
    {
      this.ijhQmXXAUZ.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.NMEQkj9tB9[i];
      else
    ...
    {
      this.NMEQkj9tB9.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.aqHQnke3dV[i];
      else
    ...
    {
      this.aqHQnke3dV.Add((object) group);
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.FHgQ1P1fNs[i];
      else
    ...
    {
      this.FHgQ1P1fNs.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingSecurityAltIDGroup GetUnderlyingSecurityAltIDGroup(int i)
    {
      if (i < this.NoUnderlyingSecurityAltID)
        return (FIXUnderlyingSecurityAltIDGroup) this.eGoQiUlqWG[i];
      else
    ...
    {
      this.eGoQiUlqWG.Add((object) group);
    ...
    public FIXUnderlyingStipsGroup GetUnderlyingStipsGroup(int i)
    {
      if (i < this.NoUnderlyingStips)
        return (FIXUnderlyingStipsGroup) this.fDgQlyXnff[i];
      else
    ...
    {
      this.fDgQlyXnff.Add((object) group);
