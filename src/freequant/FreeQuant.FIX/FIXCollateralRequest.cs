// Type: SmartQuant.FIX.FIXCollateralRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList FhB8gVMCSB;
    private ArrayList iKB8ocDq8G;
    private ArrayList A718RnQ5Vt;
    private ArrayList Ist84fFIn5;
    private ArrayList TJC8eVecm6;
    private ArrayList uCL8GIaLVe;
    private ArrayList Yq789fn9JB;
    private ArrayList fDD8skTUlt;
    private ArrayList xC88bicIri;
    private ArrayList u5N8jAFUMx;
    private ArrayList tgc8EbYXDa;
    private ArrayList sKu83tlNQQ;
    ...
    public FIXCollateralRequest()
    {
      ...
      this.Ist84fFIn5 = new ArrayList();
      this.TJC8eVecm6 = new ArrayList();
      this.uCL8GIaLVe = new ArrayList();
      this.Yq789fn9JB = new ArrayList();
      this.fDD8skTUlt = new ArrayList();
      this.xC88bicIri = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.FhB8gVMCSB[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.FhB8gVMCSB.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.iKB8ocDq8G[i];
      else
    ...
    {
      this.iKB8ocDq8G.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.A718RnQ5Vt[i];
      else
    ...
    {
      this.A718RnQ5Vt.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    {
      if (i < this.NoExecs)
        return (FIXExecsGroup) this.Ist84fFIn5[i];
      else
    ...
    {
      this.Ist84fFIn5.Add((object) group);
      ++this.NoExecs;
    }
    ...
    {
      if (i < this.NoTrades)
        return (FIXTradesGroup) this.TJC8eVecm6[i];
      else
    ...
    {
      this.TJC8eVecm6.Add((object) group);
      ++this.NoTrades;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.uCL8GIaLVe[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.Yq789fn9JB[i];
      else
    ...
    {
      this.Yq789fn9JB.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.fDD8skTUlt[i];
      else
    ...
    {
      this.fDD8skTUlt.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.xC88bicIri[i];
      else
    ...
    {
      this.xC88bicIri.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXTrdRegTimestampsGroup GetTrdRegTimestampsGroup(int i)
    {
      if (i < this.NoTrdRegTimestamps)
        return (FIXTrdRegTimestampsGroup) this.u5N8jAFUMx[i];
      else
    ...
    {
      this.u5N8jAFUMx.Add((object) group);
    ...
    public FIXMiscFeesGroup GetMiscFeesGroup(int i)
    {
      if (i < this.NoMiscFees)
        return (FIXMiscFeesGroup) this.tgc8EbYXDa[i];
      else
    ...
    {
      this.tgc8EbYXDa.Add((object) group);
      ++this.NoMiscFees;
    }
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.sKu83tlNQQ[i];
      else
    ...
    {
      this.sKu83tlNQQ.Add((object) group);
      ++this.NoStipulations;
    }
  }
}
