// Type: SmartQuant.FIX.FIXTradeCaptureReportRequestAck
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList vNCyMT14tB;
    private ArrayList hXHyvKcwx5;
    private ArrayList XuwydVvSoR;
    private ArrayList tG4yadq5se;
    private ArrayList webyLjlKyA;
    private ArrayList zEryKLjPPO;
    ...
    {
      return (FIXHopRefIDGroup) this.vNCyMT14tB[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.vNCyMT14tB.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.hXHyvKcwx5[i];
      else
    ...
    {
      this.hXHyvKcwx5.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.XuwydVvSoR[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.tG4yadq5se[i];
      else
    ...
    {
      this.tG4yadq5se.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.webyLjlKyA[i];
      else
    ...
    {
      this.webyLjlKyA.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.zEryKLjPPO[i];
      else
    ...
    {
      this.zEryKLjPPO.Add((object) group);
      ++this.NoLegs;
    }
  }
}
