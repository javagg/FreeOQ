// Type: SmartQuant.FIX.FIXQuoteRequestReject
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList MVqApGIA1P;
    private ArrayList D05AMRnA8n;
    private ArrayList R0vAvFIYW5;
    ...
    {
      return (FIXHopRefIDGroup) this.MVqApGIA1P[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.MVqApGIA1P.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.D05AMRnA8n[i];
      else
    ...
    {
      this.D05AMRnA8n.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXRelatedSymGroup GetRelatedSymGroup(int i)
    {
      if (i < this.NoRelatedSym)
        return (FIXRelatedSymGroup) this.R0vAvFIYW5[i];
      else
