// Type: SmartQuant.FIX.FIXTradeCaptureReportRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList iJnjsX25u;
    private ArrayList iA8EOPjMt;
    private ArrayList yK335YZdU;
    private ArrayList AhKFVCBrI;
    private ArrayList dbowLVq5v;
    private ArrayList BjACVR0Q3;
    private ArrayList Cb62AvP85;
    private ArrayList w9Gce2HtA;
    private ArrayList hYAzfreJT;
    ...
    public FIXTradeCaptureReportRequest()
    {
      ...
      this.AhKFVCBrI = new ArrayList();
      this.dbowLVq5v = new ArrayList();
      this.BjACVR0Q3 = new ArrayList();
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.iA8EOPjMt[i];
      else
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.yK335YZdU[i];
      else
    ...
    {
      this.yK335YZdU.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.AhKFVCBrI[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.dbowLVq5v[i];
      else
    ...
    {
      this.dbowLVq5v.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXInstrAttribGroup GetInstrAttribGroup(int i)
    {
      if (i < this.NoInstrAttrib)
        return (FIXInstrAttribGroup) this.BjACVR0Q3[i];
      else
    ...
    {
      this.BjACVR0Q3.Add((object) group);
      ++this.NoInstrAttrib;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.Cb62AvP85[i];
      else
    ...
    {
      this.Cb62AvP85.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.w9Gce2HtA[i];
      else
    ...
    {
      this.w9Gce2HtA.Add((object) group);
      ++this.NoLegs;
    }
    ...
    {
      if (i < this.NoDates)
        return (FIXDatesGroup) this.hYAzfreJT[i];
      else
        return (FIXDatesGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXDatesGroup group)
    {
      this.hYAzfreJT.Add((object) group);
      ++this.NoDates;
    }
  }
}
