// Type: SmartQuant.FIX.FIXSecurityList
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList YJEycOQFab;
    private ArrayList uhVyzW0LrR;
    private ArrayList wMshSsQU99;
    ...
    {
      return (FIXHopRefIDGroup) this.YJEycOQFab[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.YJEycOQFab.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.uhVyzW0LrR[i];
      else
    ...
    {
      this.uhVyzW0LrR.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXRelatedSymGroup GetRelatedSymGroup(int i)
    {
      if (i < this.NoRelatedSym)
        return (FIXRelatedSymGroup) this.wMshSsQU99[i];
      else
