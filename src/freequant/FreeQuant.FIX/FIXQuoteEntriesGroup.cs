// Type: SmartQuant.FIX.FIXQuoteEntriesGroup
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList unQ7nYO0i8;
    private ArrayList pbY718p7Bw;
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.unQ7nYO0i8[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.pbY718p7Bw[i];
      else
    ...
    {
      this.pbY718p7Bw.Add((object) group);
      ++this.NoEvents;
    }
  }
}
