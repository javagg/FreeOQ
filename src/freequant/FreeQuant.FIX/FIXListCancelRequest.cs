// Type: SmartQuant.FIX.FIXListCancelRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList EHuQgDPRIb;
    private ArrayList zvMQoyBxHE;
    ...
    {
      return (FIXHopRefIDGroup) this.EHuQgDPRIb[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.EHuQgDPRIb.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.zvMQoyBxHE[i];
      else
    ...
    {
      this.zvMQoyBxHE.Add((object) group);
      ++this.NoHops;
    }
  }
}
