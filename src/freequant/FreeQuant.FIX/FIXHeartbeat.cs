// Type: SmartQuant.FIX.FIXHeartbeat
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList g4lyWPTaHU;
    private ArrayList R5uyTy6s4Y;
    ...
    {
      return (FIXHopRefIDGroup) this.g4lyWPTaHU[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.g4lyWPTaHU.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.R5uyTy6s4Y[i];
      else
    ...
    {
      this.R5uyTy6s4Y.Add((object) group);
      ++this.NoHops;
    }
  }
}
