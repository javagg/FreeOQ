...
namespace FreeQuant.FIX
{
  ...
  {
    private ArrayList zQ6yBAxbHd;
    private ArrayList A15yO1ijB6;
    private ArrayList Tn1yxAkXrf;
    private ArrayList pBOy53uvYj;
    private ArrayList zIuyglVQyp;
    private ArrayList cTgyoLSmK5;
    private ArrayList NNayR4W1sI;
    private ArrayList Y95y42kgwn;
    private ArrayList LICyeQtQfw;
    private ArrayList m3UyG0YnjY;
    private ArrayList yO2y9amCf1;
    private ArrayList sK8ysXShmc;
    private ArrayList hVkybKdmlI;
    ...
    public FIXCollateralAssignment()
    {
      ...
      this.pBOy53uvYj = new ArrayList();
      this.zIuyglVQyp = new ArrayList();
      this.cTgyoLSmK5 = new ArrayList();
      this.NNayR4W1sI = new ArrayList();
      this.Y95y42kgwn = new ArrayList();
      this.LICyeQtQfw = new ArrayList();
      this.m3UyG0YnjY = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.zQ6yBAxbHd[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.zQ6yBAxbHd.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.A15yO1ijB6[i];
      else
    ...
    {
      this.A15yO1ijB6.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.Tn1yxAkXrf[i];
      else
    ...
    {
      this.Tn1yxAkXrf.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    {
      if (i < this.NoExecs)
        return (FIXExecsGroup) this.pBOy53uvYj[i];
      else
    ...
    {
      this.pBOy53uvYj.Add((object) group);
      ++this.NoExecs;
    }
    ...
    {
      if (i < this.NoTrades)
        return (FIXTradesGroup) this.zIuyglVQyp[i];
      else
    ...
    {
      this.zIuyglVQyp.Add((object) group);
      ++this.NoTrades;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.cTgyoLSmK5[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.NNayR4W1sI[i];
      else
    ...
    {
      this.NNayR4W1sI.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.Y95y42kgwn[i];
      else
    ...
    {
      this.Y95y42kgwn.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.LICyeQtQfw[i];
      else
    ...
    {
      this.LICyeQtQfw.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXTrdRegTimestampsGroup GetTrdRegTimestampsGroup(int i)
    {
      if (i < this.NoTrdRegTimestamps)
        return (FIXTrdRegTimestampsGroup) this.m3UyG0YnjY[i];
      else
    ...
    {
      this.m3UyG0YnjY.Add((object) group);
    ...
    public FIXMiscFeesGroup GetMiscFeesGroup(int i)
    {
      if (i < this.NoMiscFees)
        return (FIXMiscFeesGroup) this.yO2y9amCf1[i];
      else
    ...
    {
      this.yO2y9amCf1.Add((object) group);
      ++this.NoMiscFees;
    }
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.sK8ysXShmc[i];
      else
    ...
    public FIXDlvyInstGroup GetDlvyInstGroup(int i)
    {
      if (i < this.NoDlvyInst)
        return (FIXDlvyInstGroup) this.hVkybKdmlI[i];
      else
    ...
    {
      this.hVkybKdmlI.Add((object) group);
      ++this.NoDlvyInst;
    }
  }
}
