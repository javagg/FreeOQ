// Type: SmartQuant.FIX.FIXListStatusRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList OcHULRraYs;
    private ArrayList H1BUKhYFX4;
    ...
    {
      return (FIXHopRefIDGroup) this.OcHULRraYs[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.OcHULRraYs.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.H1BUKhYFX4[i];
      else
    ...
    {
      this.H1BUKhYFX4.Add((object) group);
      ++this.NoHops;
    }
  }
}
