// Type: SmartQuant.FIX.FIXNetworkCounterpartySystemStatusResponse
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList HC5LOjfZr;
    private ArrayList xE5KtPqdw;
    private ArrayList t2T0p5f4x;
    ...
    {
      return (FIXHopRefIDGroup) this.HC5LOjfZr[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.HC5LOjfZr.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.xE5KtPqdw[i];
      else
    ...
    {
      this.xE5KtPqdw.Add((object) group);
      ++this.NoHops;
    }
    ...
    {
      if (i < this.NoCompIDs)
        return (FIXCompIDsGroup) this.t2T0p5f4x[i];
      else
    ...
    {
      this.t2T0p5f4x.Add((object) group);
      ++this.NoCompIDs;
    }
  }
}
