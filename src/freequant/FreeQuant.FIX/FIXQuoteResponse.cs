// Type: SmartQuant.FIX.FIXQuoteResponse
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList KdQZLDZO4b;
    private ArrayList lD9ZK4AnWw;
    private ArrayList estZ0v9ZfO;
    private ArrayList tDSZDNIUZO;
    private ArrayList RP2ZP1YpM4;
    private ArrayList WreZIQ7dtO;
    private ArrayList kQZZHPUGL8;
    private ArrayList XuxZW0sy5M;
    private ArrayList K1QZTnBspe;
    ...
    public FIXQuoteResponse()
    {
      ...
      this.RP2ZP1YpM4 = new ArrayList();
      this.WreZIQ7dtO = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.KdQZLDZO4b[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.KdQZLDZO4b.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.lD9ZK4AnWw[i];
      else
    ...
    {
      this.lD9ZK4AnWw.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXQuoteQualifiersGroup GetQuoteQualifiersGroup(int i)
    {
      if (i < this.NoQuoteQualifiers)
        return (FIXQuoteQualifiersGroup) this.estZ0v9ZfO[i];
      else
    ...
    {
      this.estZ0v9ZfO.Add((object) group);
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.tDSZDNIUZO[i];
      else
    ...
    {
      this.tDSZDNIUZO.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.RP2ZP1YpM4[i];
      else
    ...
    {
      this.RP2ZP1YpM4.Add((object) group);
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.WreZIQ7dtO[i];
      else
    ...
    {
      this.WreZIQ7dtO.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.kQZZHPUGL8[i];
      else
    ...
    {
      this.kQZZHPUGL8.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.XuxZW0sy5M[i];
      else
    ...
    {
      this.XuxZW0sy5M.Add((object) group);
      ++this.NoStipulations;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.K1QZTnBspe[i];
      else
    ...
    {
      this.K1QZTnBspe.Add((object) group);
      ++this.NoLegs;
    }
  }
}
