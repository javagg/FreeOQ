// Type: SmartQuant.FIX.FIXStandardHeader
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList KoE8tjSAaa;
    private ArrayList CvK8QNR42p;
    ...
    {
      return (FIXHopRefIDGroup) this.KoE8tjSAaa[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.KoE8tjSAaa.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.CvK8QNR42p[i];
      else
    ...
    {
      this.CvK8QNR42p.Add((object) group);
      ++this.NoHops;
    }
  }
}
