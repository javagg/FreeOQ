// Type: SmartQuant.FIX.FIXSecurityListRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList nCi7oVx2qn;
    private ArrayList me47RDvtrG;
    private ArrayList HvP74JPWIJ;
    private ArrayList Nsw7ekbqXt;
    private ArrayList Jl47GDu0d2;
    private ArrayList kG279pE0Om;
    private ArrayList arI7sVNWKL;
    ...
    {
      return (FIXHopRefIDGroup) this.nCi7oVx2qn[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.nCi7oVx2qn.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.me47RDvtrG[i];
      else
    ...
    {
      this.me47RDvtrG.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.HvP74JPWIJ[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.Nsw7ekbqXt[i];
      else
    ...
    {
      this.Nsw7ekbqXt.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXInstrAttribGroup GetInstrAttribGroup(int i)
    {
      if (i < this.NoInstrAttrib)
        return (FIXInstrAttribGroup) this.Jl47GDu0d2[i];
      else
    ...
    {
      this.Jl47GDu0d2.Add((object) group);
      ++this.NoInstrAttrib;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.kG279pE0Om[i];
      else
    ...
    {
      this.kG279pE0Om.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.arI7sVNWKL[i];
      else
    ...
    {
      this.arI7sVNWKL.Add((object) group);
      ++this.NoLegs;
    }
  }
}
