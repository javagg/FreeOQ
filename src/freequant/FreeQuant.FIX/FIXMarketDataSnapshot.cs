// Type: SmartQuant.FIX.FIXMarketDataSnapshot
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList w6RtvjSq7P;
    private ArrayList nJrtd8TnPs;
    private ArrayList ytytaFo0H5;
    private ArrayList sbvtL6CbJs;
    private ArrayList WcttKmvHIu;
    private ArrayList SMYt0fhpdC;
    private ArrayList IuYtDCxTCh;
    ...
    {
      this.w6RtvjSq7P.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.nJrtd8TnPs[i];
      else
    ...
    {
      this.nJrtd8TnPs.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.ytytaFo0H5[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.sbvtL6CbJs[i];
      else
    ...
    {
      this.sbvtL6CbJs.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.WcttKmvHIu[i];
      else
    ...
    {
      this.WcttKmvHIu.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.SMYt0fhpdC[i];
      else
    ...
    {
      this.SMYt0fhpdC.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXMDEntriesGroup GetMDEntriesGroup(int i)
    {
      if (i < this.NoMDEntries)
        return (FIXMDEntriesGroup) this.IuYtDCxTCh[i];
      else
        return (FIXMDEntriesGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXMDEntriesGroup group)
    {
      this.IuYtDCxTCh.Add((object) group);
      ++this.NoMDEntries;
    }
  }
}
