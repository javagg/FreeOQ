...
namespace FreeQuant.FIX
{
  ...
  {
    private ArrayList eck7u1qXUQ;
    private ArrayList Bn17t15hg2;
    private ArrayList uap7Q3KNyo;
    ...
    public FIXRegistrationInstructionsResponse():base()
    {
      this.eck7u1qXUQ = new ArrayList();
      this.Bn17t15hg2 = new ArrayList();
      this.uap7Q3KNyo = new ArrayList();
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public FIXRegistrationInstructionsResponse(string RegistID, char RegistTransType, string RegistRefID, char RegistStatus):base()
    {
      this.eck7u1qXUQ = new ArrayList();
      this.Bn17t15hg2 = new ArrayList();
      this.uap7Q3KNyo = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.eck7u1qXUQ[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.eck7u1qXUQ.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.Bn17t15hg2[i];
      else
    ...
    {
      this.Bn17t15hg2.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.uap7Q3KNyo[i];
      else
    ...
    {
      this.uap7Q3KNyo.Add((object) group);
      ++this.NoPartyIDs;
    }
  }
}
