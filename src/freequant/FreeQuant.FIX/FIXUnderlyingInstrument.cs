// Type: SmartQuant.FIX.FIXUnderlyingInstrument
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList gKmtA9fvHt;
    private ArrayList nAat8HYJxy;
    ...
    public FIXUnderlyingInstrument()
    {
      ...
      this.gKmtA9fvHt = new ArrayList();
      this.nAat8HYJxy = new ArrayList();
    ...
    public FIXUnderlyingSecurityAltIDGroup GetUnderlyingSecurityAltIDGroup(int i)
    {
      if (i < this.NoUnderlyingSecurityAltID)
        return (FIXUnderlyingSecurityAltIDGroup) this.gKmtA9fvHt[i];
      else
    ...
    {
      this.gKmtA9fvHt.Add((object) group);
    ...
    public FIXUnderlyingStipsGroup GetUnderlyingStipsGroup(int i)
    {
      if (i < this.NoUnderlyingStips)
        return (FIXUnderlyingStipsGroup) this.nAat8HYJxy[i];
      else
    ...
    {
      this.nAat8HYJxy.Add((object) group);
