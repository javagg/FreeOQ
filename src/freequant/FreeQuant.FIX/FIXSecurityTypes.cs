...
namespace FreeQuant.FIX
{
  ...
  {
    private ArrayList tdstmRqKiv;
    private ArrayList ob9tkuYppG;
    private ArrayList uoqtnJWy2e;
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.ob9tkuYppG[i];
      else
    ...
    {
      this.ob9tkuYppG.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityTypesGroup GetSecurityTypesGroup(int i)
    {
      if (i < this.NoSecurityTypes)
        return (FIXSecurityTypesGroup) this.uoqtnJWy2e[i];
      else
        return (FIXSecurityTypesGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXSecurityTypesGroup group)
    {
      this.uoqtnJWy2e.Add((object) group);
