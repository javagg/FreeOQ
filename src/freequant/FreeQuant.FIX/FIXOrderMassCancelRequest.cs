// Type: SmartQuant.FIX.FIXOrderMassCancelRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList XjF8r7Tmbo;
    private ArrayList L378pFWHcw;
    private ArrayList Rec8MK2iIw;
    private ArrayList Csk8vjAmoD;
    private ArrayList h698d91xPA;
    private ArrayList fKP8aMJdkR;
    ...
    {
      return (FIXHopRefIDGroup) this.XjF8r7Tmbo[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.XjF8r7Tmbo.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.L378pFWHcw[i];
      else
    ...
    {
      this.L378pFWHcw.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.Rec8MK2iIw[i];
      else
    ...
    {
      this.Rec8MK2iIw.Add((object) group);
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.Csk8vjAmoD[i];
      else
    ...
    {
      this.Csk8vjAmoD.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingSecurityAltIDGroup GetUnderlyingSecurityAltIDGroup(int i)
    {
      if (i < this.NoUnderlyingSecurityAltID)
        return (FIXUnderlyingSecurityAltIDGroup) this.h698d91xPA[i];
      else
    ...
    {
      this.h698d91xPA.Add((object) group);
    ...
    public FIXUnderlyingStipsGroup GetUnderlyingStipsGroup(int i)
    {
      if (i < this.NoUnderlyingStips)
        return (FIXUnderlyingStipsGroup) this.fKP8aMJdkR[i];
      else
    ...
    {
      this.fKP8aMJdkR.Add((object) group);
