// Type: SmartQuant.FIX.FIXSettlementInstructions
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList B9XUU7XbUv;
    private ArrayList L4hUAjufHw;
    private ArrayList DVxU8kiQJt;
    ...
    {
      return (FIXHopRefIDGroup) this.B9XUU7XbUv[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.B9XUU7XbUv.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.L4hUAjufHw[i];
      else
    ...
    {
      this.L4hUAjufHw.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSettlInstGroup GetSettlInstGroup(int i)
    {
      if (i < this.NoSettlInst)
        return (FIXSettlInstGroup) this.DVxU8kiQJt[i];
      else
        return (FIXSettlInstGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXSettlInstGroup group)
    {
      this.DVxU8kiQJt.Add((object) group);
      ++this.NoSettlInst;
    }
  }
}
