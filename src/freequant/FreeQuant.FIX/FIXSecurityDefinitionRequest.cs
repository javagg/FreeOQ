...
namespace FreeQuant.FIX
{
  ...
  {
    private ArrayList cB2Y1whD9h;
    private ArrayList CA9YisUZaG;
    private ArrayList z3OYlnlrT6;
    private ArrayList yAdYBN0Dnu;
    private ArrayList I6SYO2C1Cg;
    private ArrayList RVOYxcVm75;
    private ArrayList xoyY5FZekd;
    ...
    public FIXSecurityDefinitionRequest():base()
    {
      this.cB2Y1whD9h = new ArrayList();
      this.CA9YisUZaG = new ArrayList();
      this.z3OYlnlrT6 = new ArrayList();
      this.yAdYBN0Dnu = new ArrayList();
      this.I6SYO2C1Cg = new ArrayList();
      this.RVOYxcVm75 = new ArrayList();
      this.xoyY5FZekd = new ArrayList();
    }

    public FIXSecurityDefinitionRequest(string SecurityReqID, int SecurityRequestType):base()
    {
      this.cB2Y1whD9h = new ArrayList();
      this.CA9YisUZaG = new ArrayList();
      this.z3OYlnlrT6 = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.cB2Y1whD9h[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.cB2Y1whD9h.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.CA9YisUZaG[i];
      else
    ...
    {
      this.CA9YisUZaG.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.z3OYlnlrT6[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.yAdYBN0Dnu[i];
      else
    ...
    {
      this.yAdYBN0Dnu.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXInstrAttribGroup GetInstrAttribGroup(int i)
    {
      if (i < this.NoInstrAttrib)
        return (FIXInstrAttribGroup) this.I6SYO2C1Cg[i];
      else
    ...
    {
      this.I6SYO2C1Cg.Add((object) group);
      ++this.NoInstrAttrib;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.RVOYxcVm75[i];
      else
    ...
    {
      this.RVOYxcVm75.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.xoyY5FZekd[i];
      else
    ...
    {
      this.xoyY5FZekd.Add((object) group);
      ++this.NoLegs;
    }
  }
}
