// Type: SmartQuant.FIX.FIXQuoteStatusReport
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList jmvuPkXaKX;
    private ArrayList WepuIjaNm0;
    private ArrayList HpYuH4BErM;
    private ArrayList YbiuWoihDY;
    private ArrayList s1WuTYMB6U;
    private ArrayList dO7uVJjVGJ;
    private ArrayList LPhum3q0kx;
    private ArrayList DRTukUN305;
    private ArrayList qBpunUTKgp;
    ...
    public FIXQuoteStatusReport()
    {
      ...
      this.YbiuWoihDY = new ArrayList();
      this.s1WuTYMB6U = new ArrayList();
      this.dO7uVJjVGJ = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.jmvuPkXaKX[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.jmvuPkXaKX.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.WepuIjaNm0[i];
      else
    ...
    {
      this.WepuIjaNm0.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.HpYuH4BErM[i];
      else
    ...
    {
      this.HpYuH4BErM.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.YbiuWoihDY[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.s1WuTYMB6U[i];
      else
    ...
    {
      this.s1WuTYMB6U.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.dO7uVJjVGJ[i];
      else
    ...
    {
      this.dO7uVJjVGJ.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.LPhum3q0kx[i];
      else
    ...
    {
      this.LPhum3q0kx.Add((object) group);
      ++this.NoStipulations;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.DRTukUN305[i];
      else
    ...
    {
      this.DRTukUN305.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXQuoteQualifiersGroup GetQuoteQualifiersGroup(int i)
    {
      if (i < this.NoQuoteQualifiers)
        return (FIXQuoteQualifiersGroup) this.qBpunUTKgp[i];
      else
    ...
    {
      this.qBpunUTKgp.Add((object) group);
