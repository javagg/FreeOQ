// Type: SmartQuant.FIX.FIXMarketDataRequestReject
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList P3nZnKHvkq;
    private ArrayList fkQZ1F8VGm;
    private ArrayList DTuZiGAfIo;
    ...
    {
      return (FIXHopRefIDGroup) this.P3nZnKHvkq[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.P3nZnKHvkq.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.fkQZ1F8VGm[i];
      else
    ...
    {
      this.fkQZ1F8VGm.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXAltMDSourceGroup GetAltMDSourceGroup(int i)
    {
      if (i < this.NoAltMDSource)
        return (FIXAltMDSourceGroup) this.DTuZiGAfIo[i];
      else
        return (FIXAltMDSourceGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXAltMDSourceGroup group)
    {
      this.DTuZiGAfIo.Add((object) group);
      ++this.NoAltMDSource;
    }
  }
}
