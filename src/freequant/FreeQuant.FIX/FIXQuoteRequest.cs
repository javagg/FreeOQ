// Type: SmartQuant.FIX.FIXQuoteRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList BGCUq0LinJ;
    private ArrayList amMUXL0LCW;
    private ArrayList EcMUJTqSCk;
    ...
    {
      this.BGCUq0LinJ.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.amMUXL0LCW[i];
      else
    ...
    {
      this.amMUXL0LCW.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXRelatedSymGroup GetRelatedSymGroup(int i)
    {
      if (i < this.NoRelatedSym)
        return (FIXRelatedSymGroup) this.EcMUJTqSCk[i];
      else
