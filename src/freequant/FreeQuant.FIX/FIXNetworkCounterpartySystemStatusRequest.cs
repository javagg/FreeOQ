// Type: SmartQuant.FIX.FIXNetworkCounterpartySystemStatusRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList ndR8KbXFoH;
    private ArrayList EBE80pBXqq;
    private ArrayList eX48DyyQoR;
    ...
    {
      return (FIXHopRefIDGroup) this.ndR8KbXFoH[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.ndR8KbXFoH.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.EBE80pBXqq[i];
      else
    ...
    {
      this.EBE80pBXqq.Add((object) group);
      ++this.NoHops;
    }
    ...
    {
      if (i < this.NoCompIDs)
        return (FIXCompIDsGroup) this.eX48DyyQoR[i];
      else
        return (FIXCompIDsGroup) null;
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXCompIDsGroup group)
    {
      this.eX48DyyQoR.Add((object) group);
      ++this.NoCompIDs;
    }
  }
}
