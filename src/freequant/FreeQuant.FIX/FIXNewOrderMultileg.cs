// Type: SmartQuant.FIX.FIXNewOrderMultileg
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList zWBYRh65dt;
    private ArrayList DJ1Y4INvDc;
    private ArrayList lLcYeWXG4B;
    private ArrayList AxjYG3ys0r;
    private ArrayList y2OY9NvBZQ;
    private ArrayList kYWYssgFOf;
    private ArrayList xCVYbAWKf2;
    private ArrayList zlXYjvYIgt;
    private ArrayList rGvYEHwCCk;
    ...
    public FIXNewOrderMultileg()
    {
      ...
      this.AxjYG3ys0r = new ArrayList();
      this.y2OY9NvBZQ = new ArrayList();
      this.kYWYssgFOf = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.zWBYRh65dt[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.zWBYRh65dt.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.DJ1Y4INvDc[i];
      else
    ...
    {
      this.DJ1Y4INvDc.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.lLcYeWXG4B[i];
      else
    ...
    {
      this.lLcYeWXG4B.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    {
      if (i < this.NoAllocs)
        return (FIXAllocsGroup) this.AxjYG3ys0r[i];
      else
    ...
    {
      this.AxjYG3ys0r.Add((object) group);
      ++this.NoAllocs;
    }
    ...
    public FIXTradingSessionsGroup GetTradingSessionsGroup(int i)
    {
      if (i < this.NoTradingSessions)
        return (FIXTradingSessionsGroup) this.y2OY9NvBZQ[i];
      else
    ...
    {
      this.y2OY9NvBZQ.Add((object) group);
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.kYWYssgFOf[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.xCVYbAWKf2[i];
      else
    ...
    {
      this.xCVYbAWKf2.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.zlXYjvYIgt[i];
      else
    ...
    {
      this.zlXYjvYIgt.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.rGvYEHwCCk[i];
      else
    ...
    {
      this.rGvYEHwCCk.Add((object) group);
      ++this.NoLegs;
    }
  }
}
