// Type: SmartQuant.FIX.FIXDerivativeSecurityListRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList cUSusIjhJd;
    private ArrayList ihpubOIQ8s;
    private ArrayList vBeujneRJu;
    private ArrayList lKpuEkm087;
    ...
    {
      this.cUSusIjhJd.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.ihpubOIQ8s[i];
      else
    ...
    {
      this.ihpubOIQ8s.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXUnderlyingSecurityAltIDGroup GetUnderlyingSecurityAltIDGroup(int i)
    {
      if (i < this.NoUnderlyingSecurityAltID)
        return (FIXUnderlyingSecurityAltIDGroup) this.vBeujneRJu[i];
      else
    ...
    {
      this.vBeujneRJu.Add((object) group);
    ...
    public FIXUnderlyingStipsGroup GetUnderlyingStipsGroup(int i)
    {
      if (i < this.NoUnderlyingStips)
        return (FIXUnderlyingStipsGroup) this.lKpuEkm087[i];
      else
    ...
    {
      this.lKpuEkm087.Add((object) group);
