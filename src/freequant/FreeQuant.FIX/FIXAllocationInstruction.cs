// Type: SmartQuant.FIX.FIXAllocationInstruction
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList gNvQ4Kp4fp;
    private ArrayList P5oQekQ1Iq;
    private ArrayList nWyQGOv07S;
    private ArrayList yfSQ9qj5o7;
    private ArrayList ht2QsqIbn1;
    private ArrayList qxhQb26S3a;
    private ArrayList RLxQji3vAA;
    private ArrayList riaQEnNHSx;
    private ArrayList HqyQ3mKMmT;
    private ArrayList mV8QFUe6Pr;
    private ArrayList MJ8Qw0pblT;
    private ArrayList KGvQCoSUkn;
    ...
    public FIXAllocationInstruction()
    {
      ...
      this.yfSQ9qj5o7 = new ArrayList();
      this.ht2QsqIbn1 = new ArrayList();
      this.qxhQb26S3a = new ArrayList();
      this.RLxQji3vAA = new ArrayList();
      this.riaQEnNHSx = new ArrayList();
      this.HqyQ3mKMmT = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.gNvQ4Kp4fp[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.gNvQ4Kp4fp.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.P5oQekQ1Iq[i];
      else
    ...
    {
      this.P5oQekQ1Iq.Add((object) group);
      ++this.NoHops;
    }
    ...
    {
      if (i < this.NoOrders)
        return (FIXOrdersGroup) this.nWyQGOv07S[i];
      else
    ...
    {
      this.nWyQGOv07S.Add((object) group);
      ++this.NoOrders;
    }
    ...
    {
      if (i < this.NoExecs)
        return (FIXExecsGroup) this.yfSQ9qj5o7[i];
      else
    ...
    {
      this.yfSQ9qj5o7.Add((object) group);
      ++this.NoExecs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.ht2QsqIbn1[i];
      else
    ...
    {
      this.ht2QsqIbn1.Add((object) group);
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.qxhQb26S3a[i];
      else
    ...
    {
      this.qxhQb26S3a.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXInstrAttribGroup GetInstrAttribGroup(int i)
    {
      if (i < this.NoInstrAttrib)
        return (FIXInstrAttribGroup) this.RLxQji3vAA[i];
      else
    ...
    {
      this.RLxQji3vAA.Add((object) group);
      ++this.NoInstrAttrib;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.riaQEnNHSx[i];
      else
    ...
    {
      this.riaQEnNHSx.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.HqyQ3mKMmT[i];
      else
    ...
    {
      this.HqyQ3mKMmT.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.mV8QFUe6Pr[i];
      else
    ...
    {
      this.mV8QFUe6Pr.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.MJ8Qw0pblT[i];
      else
    ...
    {
      this.MJ8Qw0pblT.Add((object) group);
      ++this.NoStipulations;
    }
    ...
    {
      if (i < this.NoAllocs)
        return (FIXAllocsGroup) this.KGvQCoSUkn[i];
      else
    ...
    {
      this.KGvQCoSUkn.Add((object) group);
      ++this.NoAllocs;
    }
  }
}
