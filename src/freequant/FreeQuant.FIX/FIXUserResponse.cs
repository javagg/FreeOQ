// Type: SmartQuant.FIX.FIXUserResponse
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList jV0yJaEIWa;
    private ArrayList UPKyrVKyla;
    ...
    {
      return (FIXHopRefIDGroup) this.jV0yJaEIWa[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.jV0yJaEIWa.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.UPKyrVKyla[i];
      else
    ...
    {
      this.UPKyrVKyla.Add((object) group);
      ++this.NoHops;
    }
  }
}
