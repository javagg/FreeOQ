// Type: SmartQuant.FIX.FIXRequestForPositionsAck
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList GdUt9sQDJC;
    private ArrayList maltsblMHI;
    private ArrayList Fe5tbmWZTa;
    private ArrayList K7ptjtejOW;
    private ArrayList HyKtEUGH4O;
    private ArrayList tXft34EY7x;
    private ArrayList AkftFpNvh4;
    ...
    {
      return (FIXHopRefIDGroup) this.GdUt9sQDJC[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.GdUt9sQDJC.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.maltsblMHI[i];
      else
    ...
    {
      this.maltsblMHI.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.Fe5tbmWZTa[i];
      else
    ...
    {
      this.Fe5tbmWZTa.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.K7ptjtejOW[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.HyKtEUGH4O[i];
      else
    ...
    {
      this.HyKtEUGH4O.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.tXft34EY7x[i];
      else
    ...
    {
      this.tXft34EY7x.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.AkftFpNvh4[i];
      else
    ...
    {
      this.AkftFpNvh4.Add((object) group);
      ++this.NoUnderlyings;
    }
  }
}
