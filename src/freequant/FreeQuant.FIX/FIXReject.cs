...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList YMhURurwMI;
    private ArrayList vl4U4ZGmU7;
    ...
    {
      this.YMhURurwMI.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.vl4U4ZGmU7[i];
      else
    ...
    {
      this.vl4U4ZGmU7.Add((object) group);
      ++this.NoHops;
    }
  }
}
