// Type: SmartQuant.FIX.FIXTradingSessionStatusRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList WkwZ8mRO2H;
    private ArrayList nqBZZjopZP;
    ...
    {
      return (FIXHopRefIDGroup) this.WkwZ8mRO2H[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.WkwZ8mRO2H.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.nqBZZjopZP[i];
      else
    ...
    {
      this.nqBZZjopZP.Add((object) group);
      ++this.NoHops;
    }
  }
}
