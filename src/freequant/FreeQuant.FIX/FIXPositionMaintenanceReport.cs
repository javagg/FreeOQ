// Type: SmartQuant.FIX.FIXPositionMaintenanceReport
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList a6YYAp2mOA;
    private ArrayList DUNY8eaRPJ;
    private ArrayList vxkYZDsaSQ;
    private ArrayList IjLYunq6x1;
    private ArrayList oLFYtFCexh;
    private ArrayList zNdYQobG4q;
    private ArrayList Q5BY7X3Ymq;
    private ArrayList WYaYYsLxSj;
    private ArrayList O5AYySSlfB;
    private ArrayList CwKYhQlxTH;
    ...
    public FIXPositionMaintenanceReport()
    {
      ...
      this.a6YYAp2mOA = new ArrayList();
      this.DUNY8eaRPJ = new ArrayList();
      this.vxkYZDsaSQ = new ArrayList();
      this.IjLYunq6x1 = new ArrayList();
      this.oLFYtFCexh = new ArrayList();
      this.zNdYQobG4q = new ArrayList();
      this.Q5BY7X3Ymq = new ArrayList();
      this.WYaYYsLxSj = new ArrayList();
      this.O5AYySSlfB = new ArrayList();
      this.CwKYhQlxTH = new ArrayList();
    ...
    {
      return (FIXHopRefIDGroup) this.a6YYAp2mOA[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.a6YYAp2mOA.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.DUNY8eaRPJ[i];
      else
    ...
    {
      this.DUNY8eaRPJ.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.vxkYZDsaSQ[i];
      else
    ...
    {
      this.vxkYZDsaSQ.Add((object) group);
      ++this.NoPartyIDs;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.IjLYunq6x1[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.oLFYtFCexh[i];
      else
    ...
    {
      this.oLFYtFCexh.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.zNdYQobG4q[i];
      else
    ...
    {
      this.zNdYQobG4q.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.Q5BY7X3Ymq[i];
      else
    ...
    {
      this.Q5BY7X3Ymq.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    public FIXTradingSessionsGroup GetTradingSessionsGroup(int i)
    {
      if (i < this.NoTradingSessions)
        return (FIXTradingSessionsGroup) this.WYaYYsLxSj[i];
      else
    ...
    {
      this.WYaYYsLxSj.Add((object) group);
    ...
    public FIXPositionsGroup GetPositionsGroup(int i)
    {
      if (i < this.NoPositions)
        return (FIXPositionsGroup) this.O5AYySSlfB[i];
      else
    ...
    {
      this.O5AYySSlfB.Add((object) group);
      ++this.NoPositions;
    }
    ...
    {
      if (i < this.NoPosAmt)
        return (FIXPosAmtGroup) this.CwKYhQlxTH[i];
      else
    ...
    {
      this.CwKYhQlxTH.Add((object) group);
      ++this.NoPosAmt;
    }
  }
}
