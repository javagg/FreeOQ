// Type: SmartQuant.FIX.FIXNewOrderCross
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList tdlthqL7Aw;
    private ArrayList oSstNxnHLo;
    private ArrayList Y4ytfHn262;
    private ArrayList P9it6r9dfA;
    private ArrayList eoatqUQcRa;
    private ArrayList wfdtXXFunb;
    private ArrayList pxftJW0te2;
    private ArrayList NiQtrF0dZU;
    private ArrayList kDgtp3TOC7;
    ...
    public FIXNewOrderCross()
    {
      ...
      this.P9it6r9dfA = new ArrayList();
      this.eoatqUQcRa = new ArrayList();
      this.wfdtXXFunb = new ArrayList();
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.oSstNxnHLo[i];
      else
    ...
    {
      if (i < this.NoSides)
        return (FIXSidesGroup) this.Y4ytfHn262[i];
      else
    ...
    {
      this.Y4ytfHn262.Add((object) group);
      ++this.NoSides;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.P9it6r9dfA[i];
      else
    ...
    {
      this.P9it6r9dfA.Add((object) group);
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.eoatqUQcRa[i];
      else
    ...
    {
      this.eoatqUQcRa.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.wfdtXXFunb[i];
      else
    ...
    {
      this.wfdtXXFunb.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.pxftJW0te2[i];
      else
    ...
    {
      this.pxftJW0te2.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXTradingSessionsGroup GetTradingSessionsGroup(int i)
    {
      if (i < this.NoTradingSessions)
        return (FIXTradingSessionsGroup) this.NiQtrF0dZU[i];
      else
    ...
    {
      this.NiQtrF0dZU.Add((object) group);
    ...
    public FIXStipulationsGroup GetStipulationsGroup(int i)
    {
      if (i < this.NoStipulations)
        return (FIXStipulationsGroup) this.kDgtp3TOC7[i];
      else
    ...
    {
      this.kDgtp3TOC7.Add((object) group);
      ++this.NoStipulations;
    }
  }
}
