...
namespace FreeQuant.FIX
{
  ...
  {
    private ArrayList X8WUWAiVhI;
    private ArrayList truUT8giCU;
    ...
    public FIXListExecute():base()
    {

      this.X8WUWAiVhI = new ArrayList();
      this.truUT8giCU = new ArrayList();

    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public FIXListExecute(string ListID, DateTime TransactTime):base()
    {
    ...
    {
      return (FIXHopRefIDGroup) this.X8WUWAiVhI[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.X8WUWAiVhI.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.truUT8giCU[i];
      else
    ...
    {
      this.truUT8giCU.Add((object) group);
      ++this.NoHops;
    }
  }
}
