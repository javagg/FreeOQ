// Type: SmartQuant.FIX.FIXMarketDataIncrementalRefresh
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList r88Aas4oYT;
    private ArrayList iFtALvd3BK;
    private ArrayList kdNAKBZaO2;
    ...
    {
      this.r88Aas4oYT.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.iFtALvd3BK[i];
      else
    ...
    {
      this.iFtALvd3BK.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXMDEntriesGroup GetMDEntriesGroup(int i)
    {
      if (i < this.NoMDEntries)
        return (FIXMDEntriesGroup) this.kdNAKBZaO2[i];
      else
    ...
    {
      this.kdNAKBZaO2.Add((object) group);
      ++this.NoMDEntries;
    }
  }
}
