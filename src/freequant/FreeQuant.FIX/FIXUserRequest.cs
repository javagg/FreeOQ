// Type: SmartQuant.FIX.FIXUserRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList DQTAjheR9b;
    private ArrayList FPwAEh5PZt;
    ...
    {
      return (FIXHopRefIDGroup) this.DQTAjheR9b[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.DQTAjheR9b.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.FPwAEh5PZt[i];
      else
    ...
    {
      this.FPwAEh5PZt.Add((object) group);
      ++this.NoHops;
    }
  }
}
