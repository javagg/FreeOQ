// Type: SmartQuant.FIX.FIXQuoteStatusRequest
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList Ya8Quj7XX;
    private ArrayList cs07PpfhN;
    private ArrayList QPMYOI6cu;
    private ArrayList sAIyCk362;
    private ArrayList JY9haFIdG;
    private ArrayList FGKNJyP8K;
    private ArrayList utUfcoPfk;
    ...
    {
      this.Ya8Quj7XX.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.cs07PpfhN[i];
      else
    ...
    {
      this.cs07PpfhN.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.QPMYOI6cu[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.sAIyCk362[i];
      else
    ...
    {
      this.sAIyCk362.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.JY9haFIdG[i];
      else
    ...
    {
      this.JY9haFIdG.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.FGKNJyP8K[i];
      else
    ...
    {
      this.FGKNJyP8K.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXPartyIDsGroup GetPartyIDsGroup(int i)
    {
      if (i < this.NoPartyIDs)
        return (FIXPartyIDsGroup) this.utUfcoPfk[i];
      else
    ...
    {
      this.utUfcoPfk.Add((object) group);
      ++this.NoPartyIDs;
    }
  }
}
