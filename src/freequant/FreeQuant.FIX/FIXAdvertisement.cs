// Type: SmartQuant.FIX.FIXAdvertisement
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList rilANGbTuy;
    private ArrayList IC7AfLVruf;
    private ArrayList Dn1A6xcG2M;
    private ArrayList pciAqm75IL;
    private ArrayList S6yAX2FwfJ;
    private ArrayList pF5AJmqSQw;
    ...
    {
      return (FIXHopRefIDGroup) this.rilANGbTuy[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.rilANGbTuy.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.IC7AfLVruf[i];
      else
    ...
    {
      this.IC7AfLVruf.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.Dn1A6xcG2M[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.pciAqm75IL[i];
      else
    ...
    {
      this.pciAqm75IL.Add((object) group);
      ++this.NoEvents;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.S6yAX2FwfJ[i];
      else
    ...
    {
      this.S6yAX2FwfJ.Add((object) group);
      ++this.NoLegs;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.pF5AJmqSQw[i];
      else
    ...
    {
      this.pF5AJmqSQw.Add((object) group);
      ++this.NoUnderlyings;
    }
  }
}
