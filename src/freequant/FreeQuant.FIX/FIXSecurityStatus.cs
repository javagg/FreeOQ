// Type: SmartQuant.FIX.FIXSecurityStatus
...
namespace SmartQuant.FIX
{
  ...
  {
    private ArrayList wrLtiMFZmp;
    private ArrayList EdBtlMbJ9o;
    private ArrayList GfKtBcv0is;
    private ArrayList VgUtOODxVy;
    private ArrayList lGLtxMIgcv;
    private ArrayList S8Ft5v5034;
    private ArrayList aRltgs3ZRQ;
    ...
    {
      return (FIXHopRefIDGroup) this.wrLtiMFZmp[i];
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public void AddGroup(FIXHopRefIDGroup group)
    {
      this.wrLtiMFZmp.Add((object) group);
    }
    ...
    {
      if (i < this.NoHops)
        return (FIXHopsGroup) this.EdBtlMbJ9o[i];
      else
    ...
    {
      this.EdBtlMbJ9o.Add((object) group);
      ++this.NoHops;
    }
    ...
    public FIXSecurityAltIDGroup GetSecurityAltIDGroup(int i)
    {
      if (i < this.NoSecurityAltID)
        return (FIXSecurityAltIDGroup) this.GfKtBcv0is[i];
      else
    ...
    {
      if (i < this.NoEvents)
        return (FIXEventsGroup) this.VgUtOODxVy[i];
      else
    ...
    {
      this.VgUtOODxVy.Add((object) group);
      ++this.NoEvents;
    }
    ...
    public FIXInstrAttribGroup GetInstrAttribGroup(int i)
    {
      if (i < this.NoInstrAttrib)
        return (FIXInstrAttribGroup) this.lGLtxMIgcv[i];
      else
    ...
    {
      this.lGLtxMIgcv.Add((object) group);
      ++this.NoInstrAttrib;
    }
    ...
    public FIXUnderlyingsGroup GetUnderlyingsGroup(int i)
    {
      if (i < this.NoUnderlyings)
        return (FIXUnderlyingsGroup) this.S8Ft5v5034[i];
      else
    ...
    {
      this.S8Ft5v5034.Add((object) group);
      ++this.NoUnderlyings;
    }
    ...
    {
      if (i < this.NoLegs)
        return (FIXLegsGroup) this.aRltgs3ZRQ[i];
      else
    ...
    {
      this.aRltgs3ZRQ.Add((object) group);
      ++this.NoLegs;
    }
  }
}
