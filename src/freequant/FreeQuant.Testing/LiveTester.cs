...
//      this.AddComponent((TesterItem) new Average(obj1 + s3j2vikrJi2pVH1Xpv.aMieSmUS9G(8600), (SeriesTesterItem) tripsExitEfficiency));
		...
		private void ER6yOMtUyy(object obj0, EventArgs obj1)
		{
		...
		private void Cndy1I50JO(DateTime obj0)
		{
		...
		private void RCnyHI5vxH(object obj0, EventArgs obj1)
		{
			lock (this)
				this.Reset();
		}
...
//      this.kFce7Nbiqu(this);
		...
		private void gFyyncG26J(object obj0, EventArgs obj1)
		{
...
//      this.GJleQFCDgF(obj0, obj1);
		...
		private void lRqy00gKm6(object sender, EventArgs e) 
		{
      if (this.ComponentListChanged != null)
      this.ComponentListChanged(sender, e);
		}
