// Type: SmartQuant.Testing.TesterItems.NegativeSeries
...
namespace SmartQuant.Testing.TesterItems
{
  public class NegativeSeries : SeriesTesterItem
  {
    ...
    public NegativeSeries(string name, SeriesTesterItem parentSeriesItem)
    {
      ...
      base.\u002Ector(name, parentSeriesItem, s3j2vikrJi2pVH1Xpv.aMieSmUS9G(9138) + parentSeriesItem.Series.Title);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public NegativeSeries(string name)
    {
      JALDIdDEhORsdnKRLQ.ot5XEbmzoL0lp();
      // ISSUE: explicit constructor call
      base.\u002Ector(name);
