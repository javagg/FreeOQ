// Type: SmartQuant.Testing.Pertrac.GainStandardDeviation
...
namespace SmartQuant.Testing.Pertrac
{
  public class GainStandardDeviation : SeriesTesterItem
  {
    ...
    public GainStandardDeviation(string name, SeriesTesterItem parentSeriesItem)
    {
      ...
      base.\u002Ector(name, parentSeriesItem, s3j2vikrJi2pVH1Xpv.aMieSmUS9G(84) + parentSeriesItem.Series.Title);
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public GainStandardDeviation(string name)
    {
      JALDIdDEhORsdnKRLQ.ot5XEbmzoL0lp();
      // ISSUE: explicit constructor call
      base.\u002Ector(name);
