...
//    [TypeConverter(typeof (ComponentTypeConverter))]
    public MetaMoneyManager MetaMoneyManager
		...
		public int MaxConnectionTime
		{
			...
			{
				if (value < 1 || value > 60)
					throw new ArgumentOutOfRangeException("MaxConnectionTime", "value < 1 || value > 60");
...
//      this.zVLWf0C4Mc = new ALxag60bMZlMBTZjqL(this);
		...
		internal void XgxWjskRHv(PortfolioStop obj0)
		{
...
//        this.zVLWf0C4Mc.ApOjaGLtYD();
		...
		private void md8Wiw2OiW(object obj0, EventArgs obj1)
		{
...
//      this.a1BRiQhS5G((object) this, EventArgs.Empty);
		...
		internal void Draw(Instrument instrument, IDrawable primitive, int padNumber)
		{
		...
		internal void x6bWBlLIvv(Exception obj0)
		{
...
//        this.f4QR7MSgh5(args);
		...
		internal void RygW1dLdu5(MarketDepthEventArgs obj0)
		{
			try
			{
				Instrument instrument = obj0.Instrument as Instrument;
		...
		private List<StrategyBase> MU0WP1r0b1(IMarketDataProvider obj0, Instrument obj1)
		{
			Dictionary<Instrument, List<StrategyBase>> dictionary = (Dictionary<Instrument, List<StrategyBase>>)null;
			List<StrategyBase> list = (List<StrategyBase>)null;
			if (this.vXRWgwkIPm.TryGetValue(obj0, out dictionary))
		...
		private List<StrategyBase> aI6WvCF8X7(IProvider obj0)
		{
		...
		internal void aBSWEaVDQP(ServiceEventArgs obj0)
		{
			try
			{
		...
		internal void Rb9WVwNDDG(ServiceErrorEventArgs obj0)
		{
			try
			{
...
//      this.zVLWf0C4Mc.J12jYHwSJS(key);
		...
		private List<StrategyBase> Y1oW8BMCy0(IService obj0)
		{
		...
		internal void t9wWcw5Scy(NewOrderSingleEventArgs obj0)
		{
			try
			{
		...
		private void OnBestObjectiveReceived(object sender, EventArgs e)
		{
			this.W31W5ysSK0();
			this.isOptimizing = false;
		}
