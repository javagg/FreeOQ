...
namespace FreeQuant.Trading
{
	...
	public class MetaRiskManager : MetaStrategyComponent
	{
		...
		{
			PortfolioStop portfolioStop = new PortfolioStop(strategy, level, type, mode, stopStrategy);
		}

		public virtual void AddStop(Strategy strategy, DateTime time, bool stopStrategy)
		{
			PortfolioStop portfolioStop = new PortfolioStop(strategy, time, stopStrategy);
		}
		...
		{
			PortfolioStop portfolioStop = new PortfolioStop(strategy, time, true);
		}
