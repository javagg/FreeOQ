// Type: SmartQuant.QuantRouterLib.ConnectionEventArgs
...
namespace SmartQuant.QuantRouterLib
{
  ...
  {
    public IConnection Connection { [MethodImpl(MethodImplOptions.NoInlining)] get; [MethodImpl(MethodImplOptions.NoInlining)] private set; }
