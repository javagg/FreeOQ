// Type: SmartQuant.QuantRouterLib.Data.BrokerInfoEventArgs
...
namespace SmartQuant.QuantRouterLib.Data
{
  ...
  {
    public BrokerInfo BrokerInfo { [MethodImpl(MethodImplOptions.NoInlining)] get; [MethodImpl(MethodImplOptions.NoInlining)] private set; }
