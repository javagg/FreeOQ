...
namespace FreeQuant.Instruments
{
    public class Performance
    {
        ...
        private void faxB4aWy0q(object obj0, EventArgs obj1)
        {
            this.GcxBG7nv0L();
        }

        private void FZABJ7ZbGj(DateTime obj0)
        {
        ...
        private void FnhBrkOUJ3(DateTime obj0, double obj1, double obj2)
        {
...
//				this.VpPUJn  = 1.0 - obj1 / this.highEquity;
        ...
        private void SijB3EsC7m(DateTime obj0)
        {
        ...
        private void PSxBNlvv0d(DateTime obj0)
        {
