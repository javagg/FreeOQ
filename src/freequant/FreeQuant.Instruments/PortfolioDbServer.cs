...
//      command2.CommandText = gUqQbWj9pYGI8tO6Z8.iW3dklQ6Dr(8180);
        ...
        private Instrument xKIEA4RkYI(int obj0)
        {
        ...
        private void ospEgWBc0j(Portfolio obj0)
        {
//      IDbCommand command = this.connection.CreateCommand();
...
//      command.Dispose();
        ...
        private void GG5E1xwBnb(Portfolio obj0)
        {
//      IDbCommand command = this.connection.CreateCommand();
...
//      command.Dispose();
        ...
        private void lwxEohW3ad(Portfolio obj0)
        {
//      IDbCommand command1 = this.connection.CreateCommand();
...
//      command2.Dispose();
        ...
        private void k2YExH5Ue4(Portfolio obj0)
        {
            IDbCommand command = this.connection.CreateCommand();
...
//      this.FQ3ELAbSkh(gUqQbWj9pYGI8tO6Z8.iW3dklQ6Dr(9370), gUqQbWj9pYGI8tO6Z8.iW3dklQ6Dr(9414), gUqQbWj9pYGI8tO6Z8.iW3dklQ6Dr(9428));
        ...
        private void FQ3ELAbSkh(string obj0, string obj1, string obj2)
        {
        }
