...
{
	public class QuickFIX43Application : MessageCracker, IFIXApplication, IApplication
	{
		...
		public QuickFIX43Application() : base()
		{
		...
		{
			Console.WriteLine("SessionID: " + (object)sessionID + ", Message: " + message);
		}
		...
		public void onMessage(QuickFix.FIX43.MarketDataSnapshotFullRefresh snapshot, SessionID sessionID)
		{
		...
		public void onMessage(QuickFix.FIX43.MarketDataRequestReject reject, SessionID sessionID)
		{
		...
		public void onMessage(QuickFix.FIX43.SecurityDefinition definition, SessionID sessionID)
		{
		}
		...
		protected void EmitExecutionReport(FreeQuant.FIX.ExecutionReport report)
		{
			if (this.grxym6Rmr == null)
				return;
		...
		protected void EmitOrderCancelReject(FreeQuant.FIX.OrderCancelReject reject)
		{
