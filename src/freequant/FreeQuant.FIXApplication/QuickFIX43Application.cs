...
namespace SmartQuant.FIXApplication
{
  public class QuickFIX43Application : QuickFix43.MessageCracker, IFIXApplication, Application
  {
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(0) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(22));
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(28) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(48));
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(54) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(76));
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(82) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(102) + (string) (object) message + BeAEwTZGlZaeOmY5cm.J00weU3cM6(110));
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void toApp(QuickFix.Message message, SessionID sessionID)
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(116) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(132) + (string) (object) message + BeAEwTZGlZaeOmY5cm.J00weU3cM6(140));
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    public virtual void fromAdmin(QuickFix.Message message, SessionID sessionID)
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(146) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(170) + (string) (object) message + BeAEwTZGlZaeOmY5cm.J00weU3cM6(178));
      message.Dispose();
    }
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(184) + (object) sessionID + BeAEwTZGlZaeOmY5cm.J00weU3cM6(204) + (string) (object) message + BeAEwTZGlZaeOmY5cm.J00weU3cM6(212));
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    protected void SetUserDefinedFields(FIXMessage Message, QuickFix43.Message message)
    {
    ...
    public override void onMessage(MarketDataSnapshotFullRefresh snapshot, SessionID sessionID)
    {
      ...
      if (this.QhlC0Jqu8 == null)
        return;
      this.QhlC0Jqu8((object) this, new FIXMarketDataSnapshotEventArgs(MarketDataSnapshotFullRefresh));
    }
    ...
    public override void onMessage(QuickFix43.MarketDataRequestReject reject, SessionID sessionID)
    {
      ...
      if (this.Hfah5KuOA == null)
        return;
      this.Hfah5KuOA((object) this, new FIXMarketDataRequestRejectEventArgs(MarketDataRequestReject));
    }
    ...
    [MethodImpl(MethodImplOptions.NoInlining)]
    public override void onMessage(QuickFix43.ExecutionReport report, SessionID sessionID)
    {
    ...
    {
      Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(218));
      ...
      {
        Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(322) + ex.Message);
      }
    }
    ...
    public virtual void Send(FIXMarketDataSnapshot Snapshot)
    {
      ...
      {
        Console.WriteLine(BeAEwTZGlZaeOmY5cm.J00weU3cM6(374) + ex.Message);
      }
    }
    ...
    {
      QuickFix43.NewOrderSingle newOrderSingle = new QuickFix43.NewOrderSingle(new ClOrdID(Order.ClOrdID), new HandlInst(Order.HandlInst), new QuickFix.Side(Order.Side), new TransactTime(Order.TransactTime), new QuickFix.OrdType(Order.OrdType));
    ...
    protected void EmitExecutionReport(SmartQuant.FIX.ExecutionReport report)
    {
      if (this.grxym6Rmr == null)
        return;
      this.grxym6Rmr((object) this, new ExecutionReportEventArgs(report));
    }

    [MethodImpl(MethodImplOptions.NoInlining)]
    protected void EmitOrderCancelReject(SmartQuant.FIX.OrderCancelReject reject)
    {
      if (this.fU9JjraQi == null)
        return;
      this.fU9JjraQi((object) this, new OrderCancelRejectEventArgs(reject));
    }
