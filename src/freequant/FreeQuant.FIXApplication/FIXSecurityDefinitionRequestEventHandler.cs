// Type: SmartQuant.FIXApplication.FIXSecurityDefinitionRequestEventHandler
...
{
  public delegate void FIXSecurityDefinitionRequestEventHandler(object sender, FIXSecurityDefinitionRequestEventArgs args);
}
