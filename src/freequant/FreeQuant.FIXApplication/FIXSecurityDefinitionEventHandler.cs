// Type: SmartQuant.FIXApplication.FIXSecurityDefinitionEventHandler
...
{
  public delegate void FIXSecurityDefinitionEventHandler(object sender, FIXSecurityDefinitionEventArgs args);
}
