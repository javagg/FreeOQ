// Type: SmartQuant.FIXApplication.FIXMarketDataSnapshotEventHandler
...
{
  public delegate void FIXMarketDataSnapshotEventHandler(object sender, FIXMarketDataSnapshotEventArgs args);
}
