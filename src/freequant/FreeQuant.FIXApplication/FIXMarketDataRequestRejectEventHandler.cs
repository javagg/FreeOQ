// Type: SmartQuant.FIXApplication.FIXMarketDataRequestRejectEventHandler
...
{
  public delegate void FIXMarketDataRequestRejectEventHandler(object sender, FIXMarketDataRequestRejectEventArgs args);
}
