// Type: SmartQuant.FIXApplication.FIXMarketDataIncrementalRefreshEventHandler
...
{
  public delegate void FIXMarketDataIncrementalRefreshEventHandler(object sender, FIXMarketDataIncrementalRefreshEventArgs args);
}
