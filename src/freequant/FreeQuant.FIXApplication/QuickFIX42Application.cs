...
{
	public class QuickFIX42Application : MessageCracker, IFIXApplication, IApplication
	{
		...
		public QuickFIX42Application() : base()
		{
		...
		public void onMessage(QuickFix.FIX42.SecurityDefinition definition, SessionID sessionID)
		{
		}
