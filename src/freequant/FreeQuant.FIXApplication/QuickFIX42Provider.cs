...
namespace FreeQuant.FIXApplication
{
	public class QuickFIX42Provider : IMarketDataProvider, IInstrumentProvider, IProvider, IExecutionProvider
	{
		...
		protected QuickFix.FIX42.MessageFactory messageFactory;
		...
		public virtual void SendOrderStatusRequest(FreeQuant.FIX.OrderStatusRequest request)
		{
		}
